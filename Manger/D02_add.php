    ...
    <td width="100%" valign="top"><!-- Main Body -->
      <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
          ...
          <td class="system_title_cht">書籍資料管理 - 新增</td>
        </tr>
      </table>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td bgcolor="#FFFFFF">&nbsp;</td>
          <td bgcolor="#FFFFFF">
		<form name="form1" method="post" action="D02_addDB.php" onSubmit="return jsCheck();" enctype="multipart/form-data">
          <table width="95%" border="0" align="center" cellpadding="0" cellspacing="1">
            ...
            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="1">
              ...
              <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                <td width="110" align="right" class="list_sn"><font color="red">*</font>供應商名稱 ：</td>
                <td colspan="3" class="list_txt"><input name="Fa_name" type="text" class="form_input_w200" maxlength="20" id="Fa_no" /></td>
              </tr>
              <tr>
                <td colspan="4" background="images/body_sep_line.gif" height="2"></td>
              </tr>
              <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                <td width="110" align="right" class="list_sn"><font color="red">*</font>負責人 ：</td>
                <td colspan="3" class="list_txt"><input name="Fa_per" type="text" class="form_input_w200" maxlength="20" id="Fa_per"></td>
              </tr>
              <tr>
                <td colspan="4" background="images/body_sep_line.gif" height="2"></td>
              </tr>                                                        
              <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                ...
                <td colspan="3" class="list_txt"><input name="Fa_tel" type="text" class="form_input_w200" maxlength="20" id="Fa_addr"></td>
                </tr>
              <tr>
                <td colspan="4" background="images/body_sep_line.gif" height="2"></td>
              </tr>                                                        
             <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                ...
                <td colspan="3" class="list_txt"><input name="Fa_addr" type="text" class="form_input_w200" maxlength="20" id="Fa_addr"></td>
                </tr>
              <tr>
                <td colspan="4" background="images/body_sep_line.gif" height="2"></td>
              </tr>
              <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                ...
                <td colspan="3" class="list_txt"><input name="Fa_email" type="text" class="form_input_w200" maxlength="20" id="Fa_addr"></td>
                </tr>
              <tr>
                <td colspan="4" background="images/body_sep_line.gif" height="2"></td>
              </tr>                                                        
