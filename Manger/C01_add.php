    ...
    <td width="100%" valign="top"><!-- Main Body -->
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td bgcolor="#FFFFFF">&nbsp;</td>
          <td bgcolor="#FFFFFF">
		<form name="form1" method="post" action="C01_addDB.php" onSubmit="return jsCheck();" enctype="multipart/form-data">
          <table width="95%" border="0" align="center" cellpadding="0" cellspacing="1">
            ...
            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="1">
              ...
              <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                <td width="110" align="right" class="list_sn"><font color="red">*</font>書名 ：</td>
                <td colspan="3" class="list_txt"><input name="It_name" type="text" class="form_input_w200" maxlength="20" id="It_name" /></td>
              </tr>
              <tr>
                <td colspan="4" background="images/body_sep_line.gif" height="2"></td>
              </tr>
              <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                <td width="110" align="right" class="list_sn"><font color="red">*</font>價錢 ：</td>
                <td colspan="3" class="list_txt"><input name="It_pri" type="text" class="form_input_w200" maxlength="20" id="It_pri"></td>
              </tr>
              <tr>
                <td colspan="4" background="images/body_sep_line.gif" height="2"></td>
              </tr>                                                        
              <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                <td width="110" align="right" class="list_sn"><font color="red">*</font>庫存 ：</td>
                <td colspan="3" class="list_txt"><input name="It_nowqty" type="text" class="form_input_w200" maxlength="20" id="It_nowqty"></td>
                </tr>
              <tr>
                <td colspan="4" background="images/body_sep_line.gif" height="2"></td>
              </tr> 
