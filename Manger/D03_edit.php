...
$SQL_select="select * from fact where Fa_no= '" . $Fa_no . "';";
    ...
    <td width="100%" valign="top"><!-- Main Body -->
      <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
          ...
          <td class="system_title_cht">廠商資料管理 - 修改</td>
        </tr>
      </table>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td bgcolor="#FFFFFF">&nbsp;</td>
          <td bgcolor="#FFFFFF">
		<form name="form1" method="post" action="D03_editDB.php" onSubmit="return jsCheck();" enctype="multipart/form-data">
          <table width="95%" border="0" align="center" cellpadding="0" cellspacing="1">
            ...
            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="1">
              ...
              <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                <td width="110" align="right" class="list_sn">供應商編號 ：</td>
                <td colspan="3" class="list_txt"><?=htmlspecialchars($row["Fa_no"])?><input name="Fa_no" type="hidden" value="<?=$row["Fa_no"]?>"></td>
              </tr>
              <tr>
                <td colspan="4" background="images/body_sep_line.gif" height="2"></td>
              </tr>
              ...
              <tr>
			   <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                <td width="110" align="right" class="list_sn">供應商名稱 ：</td>
                <td colspan="3" class="list_txt"><input name="Fa_name" type="text" class="form_input_w200" maxlength="20" value="<?=$row["Fa_name"]?>"></td>
              </tr>
                <td colspan="4" background="images/body_sep_line.gif" height="2"></td>
              </tr>
              <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                <td width="110" align="right" class="list_sn">負責人 ：</td>
                <td colspan="3" class="list_txt"><input name="Fa_per" type="text" class="form_input_w200" maxlength="20" value="<?=$row["Fa_per"]?>"></td>
              </tr>
              <tr>
                <td colspan="4" background="images/body_sep_line.gif" height="2"></td>
              </tr>                                                        
              ...
              <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                ...
                <td colspan="3" class="list_txt"><input name="Fa_tel" type="text" class="input-name" maxlength="20" value="<?=htmlspecialchars($row["Fa_tel"])?>"></td>
                </tr>
              <tr>
                <td colspan="4" background="images/body_sep_line.gif" height="2"></td>
              </tr>
             ...
             <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                ...
                <td colspan="3" class="list_txt"><input name="Fa_addr" type="text" class="input-name" maxlength="20" value="<?=htmlspecialchars($row["Fa_addr"])?>"></td>
             ...
             <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                ...
                <td colspan="3" class="list_txt"><input name="Fa_email" type="text" class="input-name" maxlength="20" value="<?=htmlspecialchars($row["Fa_email"])?>"></td>
