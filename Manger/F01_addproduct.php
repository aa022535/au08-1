          ...
          <table width="95%" border="0" align="center" cellpadding="0" cellspacing="1">
            ...
            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="1">
              ...
              <tr>
			   ...
			   <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
			   <td width="110" align="right" class="list_sn"><font color="red">*</font>供應商編號 ：<select name="Fa_no" id="Fa_no" > 
...
$shops = mysql_query("select * from fact;");
if(!$shops){
...
{
	$shopCodeArr[$shopCount]=$rows['Fa_no'];
	$shopCount++;
}
for($i=0;$i<count($shopCodeArr);$i++)
{
	echo "<script type=\"text/javascript\">";
	echo "document.getElementById(\"Fa_no\").options[$i]=new Option(\"$shopCodeArr[$i]\",\"$shopCodeArr[$i]\");";
	echo "</script>";
}
?>
	</tr> 		  
